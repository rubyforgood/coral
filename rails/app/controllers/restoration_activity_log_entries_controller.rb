class RestorationActivityLogEntriesController < ApplicationController
  ...
  def restoration_activity_log_entry_params
    params.require(:restoration_activity_log_entry).permit(:cleaned, :corals_added, :bleached_corals, :dead_corals, :removed_for_planting, :dive_id, :nursery_table_id, images: [])
  end
